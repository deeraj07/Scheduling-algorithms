    ...
    def schedulingProcess(self, process_data):
        ...
        while 1:
            ...
            if len(ready_queue) != 0:
                ready_queue.sort(key=lambda x: x[3], reverse=True)#keep reverse=true for highest number highest priority otherwise remove for lowest number highest priority
